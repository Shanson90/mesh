...
{$('body').off('uabb-trigger.'+hook,callback);},};})(jQuery);jQuery(document).ready(function($){var uabb_browser=bowser.name,uabb_browser_v=bowser.version,uabb_browser_class=uabb_browser.replace(/\s+/g,'-').toLowerCase(),uabb_browser_v_class=uabb_browser_class+parseInt(uabb_browser_v);$('html').addClass(uabb_browser_class).addClass(uabb_browser_v_class);});var wpAjaxUrl='https://www.meshtechdesign.com/wp-admin/admin-ajax.php';var flBuilderUrl='https://www.meshtechdesign.com/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'https://www.meshtechdesign.com/wp-content/plugins/bb-plugin/',wpAjaxUrl:'https://www.meshtechdesign.com/wp-admin/admin-ajax.php'},breakpoints:{small:768,medium:1024},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);(function($){jQuery(document).ready(function(){});})(jQuery);(function($){jQuery(document).ready(function(){});})(jQuery);(function($){jQuery(document).ready(function(){});})(jQuery);(function($){jQuery(document).ready(function(){});})(jQuery);(function($){jQuery(document).ready(function(){});})(jQuery);